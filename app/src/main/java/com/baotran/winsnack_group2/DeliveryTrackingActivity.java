...
public class DeliveryTrackingActivity extends AppCompatActivity {
    ...
    private void setupClickListeners() {
        ...
        btnReturnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeliveryTrackingActivity.this, HomeActivity.class);
        ...
        btnTrackOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeliveryTrackingActivity.this, OrderDetailsActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                updateTrackingStatus();
                finish();
